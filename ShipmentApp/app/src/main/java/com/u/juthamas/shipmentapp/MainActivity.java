...
public class MainActivity extends Activity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //editText of ID
            final EditText editID = (EditText)rootView.findViewById(R.id.IDtracking);

            //button Tracking
            final Button btnTack = (Button)rootView.findViewById(R.id.buttonTrack);
                    ...
                    if(!txt.isEmpty()){
                        new HttpHandler(){
                            ...
                            public HttpUriRequest getHttpRequestMethod() {
                                HttpGet request = new HttpGet("http://track-trace.tk:8080/shipments/"+txt+"/status");
...
//                        Toast.makeText(getActivity(), String.valueOf("Your ID is " + txt), Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(getActivity(), "Please add Shipment's number", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            return rootView;
